...
linked episode data, procurement evidence, deployment outcome data, and
independent statistical reproduction.  The manuscripts label those items as
...
\textbf{Location.} Economic accounting, conservative scenarios, deployment
cost, break-even, pathway, adoption, and sensitivity sections, and
...
One-time integration, annual operations/training/security, and replacement or
upgrade costs are modeled.  Gross value, net benefit, benefit--cost ratio, and
break-even costs are separate.  Near-term rollout scales are separate from
...
\item mature mortality-neutral societal median: \USD1.921 billion;
\item illustrative annualized deployment-cost median: \USD2.078 billion;
\item mature net benefit excluding VSL: median $-\USD148$ million, with median
benefit--cost ratio $0.93$; and
...
\item obtain engineering, procurement, cybersecurity, training, maintenance,
receiving-system, and agency-budget evidence for the cost distributions;
...
\item Preserve the mortality-neutral, evidence-floor, break-even, and
